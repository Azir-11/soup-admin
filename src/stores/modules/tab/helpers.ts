 ...
 */
export function getIndexInTabRoutes(tabs, fullPath: string) {
 ...
 * @param fullPath - 该页签的路径
 */
export function isInTabRoutes(tabs, fullPath: string) {
 ...
 */
export function getIndexInTabRoutesByRouteName(tabs, routeName: string) {
